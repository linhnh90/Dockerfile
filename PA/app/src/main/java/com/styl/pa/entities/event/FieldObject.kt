...
class FieldObject() : Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<FieldObject> {
        override fun createFromParcel(parcel: Parcel): FieldObject {
            return FieldObject(parcel)
        }

        override fun newArray(size: Int): Array<FieldObject?> {
